...
- Minor oopsie in `handleScreenshotCapture`
...
- Update system prompt for footnotes

### 🐛 Bug Fixes

- Relax permissions required for `host_permissions` and `content_scripts`
- Set default action to the take screenshot action
